...
def sentence3() -> Expr:
    ...
    Sentences=[Expr("PacmanAlive[1]")%((Expr("PacmanAlive[0]")&~Expr("PacmanKilled[0]"))|(~Expr("PacmanAlive[0]")&Expr("PacmanBorn[0]")))
...
def plTrueInverse(assignments: Dict[Expr, bool], inverse_statement: Expr) -> bool:
    ...
    """
    assignmentKB=[a for a in assignments.keys() if assignments[a]==True]+[~a for a in assignments.keys() if assignments[a]==False]
